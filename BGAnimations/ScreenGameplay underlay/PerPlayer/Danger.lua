...
if not (FailString and FailString == "FailOff") then
	...
	local danger = Def.Quad{
		...
		DangerCommand=cmd(linear,0.3; diffusealpha,0.4; diffuseshift; effectcolor1, 1, 0, 0.24, 0.1; effectcolor2, 1, 0, 0, 0.35),
		...
		OutOfDangerCommand=cmd(diffusealpha,0; stopeffect; stoptweening; diffuse,color("0,0,0"); linear,0.3; diffusealpha,0.0; linear,0.3; diffusealpha,0),
